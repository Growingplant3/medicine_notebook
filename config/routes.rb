Rails.application.routes.draw do
  ...
  patch '/users/:id/medicine_notebook/:medicine_notebook_id/edit', to: 'medicine_notebook_records#update'
  delete '/users/:id/medicine_notebook/:medicine_notebook_id/edit', to: 'medicine_notebook_records#destroy'
  root 'homes#index'
end